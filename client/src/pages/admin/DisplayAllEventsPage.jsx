  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between px-2">
        <h1 className="text-3xl font-bold text-gray-800 p-2">All Events</h1>
        <Button
      ...
      <div className="pt-4">
        ...
        {!loading && (
          <Table className="font-medium text-lg">
            <TableCaption>List of Events | Book My Event</TableCaption>
            <TableHeader>
              <TableRow>
                <TableHead></TableHead>
              ...
              {eventsData &&
                ...
                eventsData.map((e, i) => (
                  <TableRow key={i}>
                    ...
                    <TableCell>
                      {moment(e.eventDate).format("DD-MMMM-YYYY")}
                    </TableCell>
