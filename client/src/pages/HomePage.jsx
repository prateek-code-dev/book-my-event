  ...
  return (
    <div>
      ...
      <div className="flex gap-2  w-full">
        ...
        <Button className="cursor-pointer text-lg">Clear Filters</Button>
        <Button className="cursor-pointer text-lg">Apply Filters</Button>
      </div>
      ...
      <div className="flex flex-col items-center justify-center mt-8 gap-2 w-full">
        ...
        {!loading &&
          ...
          allEventsData.map((item, index) => (
            <div className="flex border-2 p-2 w-full gap-4" key={index}>
              ...
              <div className="w-full">
                <p className="text-xl font-bold h-1/6">{item?.eventName}</p>

                <p className="text-xl mt-4 h-1/3 ">{item?.eventDescription}</p>
